      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
            ...
            <p className="text-blue-100 mt-1">Set up your custom domain for the child panel</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className={`w-full h-12 px-4 py-2 border-2 rounded-md ${errors.domain ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-blue-500"}`}
              />
              {errors.domain && (
                  ...
                  <div className="space-y-2">
                    {nameservers.map((ns, index) => (
                      <div key={index} className="flex items-center justify-between bg-white p-3 rounded border">
                        <code className="font-mono text-sm text-blue-700">{ns}</code>
                        <button
                          onClick={() => copyNameserver(ns)}
                          className="px-3 py-1.5 border border-blue-200 rounded-md text-blue-600 hover:bg-blue-50"
                        >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full h-12 px-4 py-2 border-2 rounded-md ${errors.adminUsername ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-blue-500"}`}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full h-12 pl-8 px-4 py-2 border-2 rounded-md ${errors.pricePerMonth ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-blue-500"}`}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full h-12 px-4 py-2 pr-10 border-2 rounded-md ${errors.adminPassword ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-blue-500"}`}
                      />
                      <button
                        type="button"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full h-12 px-4 py-2 pr-10 border-2 rounded-md ${errors.confirmPassword ? "border-red-300 focus:border-red-500" : "border-gray-200 focus:border-blue-500"}`}
                      />
                      <button
                        type="button"
                        className="absolute right-0 top-0 h-12 px-3 hover:bg-gray-50 rounded-r-md"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full h-14 px-4 py-2 text-lg font-semibold bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-md shadow-lg transition-all duration-200 disabled:opacity-70 flex items-center justify-center"
            >
              {isSubmitting ? (
                <>
