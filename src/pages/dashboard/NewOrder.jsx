                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 mt-2">
                    <span className="text-xs text-green-600 font-medium">
                      {formatCurrency(convertToSelectedCurrency(service.price, "NGN"), selectedCurrency)} per 1k
                    </span>
              ...
              <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {quantity} units × {selectedService ? formatCurrency(convertToSelectedCurrency(selectedService.price, "NGN"), selectedCurrency) : '0'} per 1k
                  </p>
                </div>
              </div>
