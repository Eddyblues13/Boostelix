...
const BalanceWarning = ({ selectedService, quantity, totalCost, convertedBalance, formattedTotalCost, formattedBalance, formatCurrency, selectedCurrency }) => {
  ...
  return (
    <div className="bg-red-50 border border-red-200 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-3">
      <div className="flex items-start">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-red-600 text-[10px] sm:text-xs mt-0.5 break-words">
