...
const SearchBar = ({
  ...
  return (
    <div className="relative">
      ...
      <input
        type="text"
        placeholder={isMobile ? "Search services... (min 2 characters)" : "Search services... (minimum 2 characters)"}
        value={searchQuery}
        onChange={onSearchChange}
        onFocus={onSearchFocus}
        onBlur={onSearchBlur}
        className={`w-full ${isMobile ? 'pl-10 pr-4 py-3 text-base' : 'pl-12 pr-4 py-4 text-lg'} border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-gray-50`}
      />
