    ...
    <div className={`bg-white ${isMobile ? 'rounded-xl p-4' : 'rounded-2xl p-6'} shadow-sm border border-gray-100 w-full overflow-hidden ${!isMobile && 'sticky top-6'}`}>
      ...
      <div className={`grid grid-cols-2 ${isMobile ? 'gap-3 mb-4' : 'gap-4 mb-6'}`}>
        <div className={`bg-gray-50 rounded-xl ${isMobile ? 'p-3' : 'p-4'}`}>
          <h5 className={`${isMobile ? 'text-xs' : 'text-sm'} font-medium text-gray-600 ${isMobile ? 'mb-2' : 'mb-2'}`}>
            Start Time
          </h5>
      ...
      {/* Service Description */}
      <div>
        <h5 className={`${isMobile ? 'text-base' : 'text-lg'} font-medium text-gray-600 ${isMobile ? 'mb-3' : 'mb-4'}`}>
          Description
        </h5>
