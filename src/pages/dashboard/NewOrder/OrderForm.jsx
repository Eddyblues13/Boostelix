  ...
  return (
    <div className={`bg-white ${isMobile ? 'rounded-xl p-3 sm:p-4 md:p-5' : 'rounded-2xl p-6'} shadow-sm border border-gray-100`}>
      ...
      <div className={`${isMobile ? 'space-y-3 sm:space-y-4' : 'space-y-6'}`}>
          ...
          <div>
            ...
            {loadingServices ? (
              ...
              <>
                ...
                {selectedService && (
                  <div className={`${isMobile ? 'mt-2' : 'mt-3'} flex items-center gap-2`}>
        ...
        <div className={`grid grid-cols-1 ${!isMobile && 'md:grid-cols-2'} ${isMobile ? 'gap-4' : 'gap-6'}`}>
          <div>
            ...
            <input
              ...
              className={`w-full px-4 ${isMobile ? 'py-3 text-base' : 'py-4 text-lg'} border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-gray-50`}
              required
            />
          </div>
        ...
        {/* Cost Summary */}
        <div className={`bg-blue-50 rounded-xl ${isMobile ? 'p-4' : 'p-6'} border border-blue-100`}>
          <div className="text-center">
            <p className={`${isMobile ? 'text-sm' : 'text-xl'} text-gray-600 ${isMobile ? 'mb-1' : 'mb-3'}`}>
              Total Cost
            </p>
            <p className={`${isMobile ? 'text-2xl' : 'text-4xl'} font-bold text-gray-800 ${isMobile ? 'mb-3' : 'mb-3'}`}>
              {formattedTotalCost}
            </p>
            <p className={`${isMobile ? 'text-xs' : 'text-lg'} text-gray-500`}>
        ...
        <button
          ...
          className={`w-full text-white font-semibold ${isMobile ? 'py-4 text-base' : 'py-5 text-xl'} rounded-xl shadow-lg flex items-center justify-center transition-all duration-200 hover:opacity-90`}
