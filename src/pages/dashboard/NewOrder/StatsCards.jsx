        ...
        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-800 truncate">{formattedBalance}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-800 truncate">{user?.status || "NEW"}</h3>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1 overflow-hidden">
              ...
              <h3 
                className="text-base sm:text-lg font-bold text-gray-800 truncate break-all"
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-4 shadow-sm border border-gray-100">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-800">{user?.total_orders || "0"}</h3>
            </div>
          </div>
        </div>
      </div>
