      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
        <div className="flex items-center gap-4 mb-4 sm:mb-0">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-white rounded-full flex items-center justify-center border-2 border-purple-200">
      ...
      <div className="bg-white rounded-lg p-4 border border-purple-100">
        ...
        {showPasswordChange && (
          <form onSubmit={onPasswordUpdate} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200 flex items-center justify-center gap-2 font-medium"
            >
