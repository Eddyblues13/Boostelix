...
const Sidebar = ({
  ...
  const sidebarItems = [
    ...
    { icon: FolderPlus, label: 'Add Category', to: '/admin/add-category' },
    { icon: Folder, label: 'Show Categories', to: '/admin/show-categories' },
    { icon: UserPlus, label: 'Add Provider', to: '/admin/add-provider' },
    { icon: Zap, label: 'API Providers', to: '/admin/api-providers' },
